    ...
    return (
      <div className="dashboard-container container">
        <Header type="h2">bPanel Dashboard</Header>
        {
          ...
          <div>
            <Text type="p">
              This is a simple Dashboard view that can be decorated by widgets. Widgets
              allow you to extend your dashboard according to your needs.
            </Text>
            <Text type="p">
              In order to add widgets to this view, you can install any
              compatible widget plugin, or create your own. This allows each user to compose their own customized
              dashboard view! Once you've installed your first widget, this intro text will disappear.
            </Text>
            <Text type="p">
              Some widgets we recommend to get started:
            </Text>
            <ul>
            ...
            <Text type="p">
              Use <Link to="https://www.npmjs.com/package/@bpanel/bpanel-cli">bpanel-cli</Link> to install
              as many widgets or other plugins as you want!
            </Text>
          </div>
          )
        }
